...
public class TankClient extends Frame implements ActionListener{
	...
	Tank homeTank = new Tank (300,560,true,Direction.STOP,this);
	 ...
	 List<Tree> trees = new ArrayList<Tank>();
	 List<Bullets> bullets = new ArrayList<Bullets>;
	 List<CommonWall> homeWall = new ArrayList<CommonWall>();
	 List<CommomWall> otherWall = new ArrayList<CommonWall>();
	 ...
	 public void framPaint (Graphics g){
		 ...
		 g.drawString("q1", 200, 70);
		 g.setFont(new Font("TimesRoman",Font.BOLD,20));
		 g.drawString(""+tanks.size(),400,70);
		 g.setFont(new Font("TimesRoman",Font.BOLD,20));
		 g.drawString("q2", 500, 70);
		 g.setFont(new Font("TimesRoma",Font.ITALIC,30));
	 ...
	 public TankClient(){
		 ...
		 jmi1 = new MenuItem("f1");
		 jmi2 = new MenuItem("f2");
		 jmi3 = new MenuItem("f3");
		 jmi4 = new MenuItem("f4");
		 jmi5 = new MenuItem("f5");
		 jmi6 = new MenuItem("f6");
		 jmi7 = new MenuItem("f7");
		 jmi8 = new MenuItem("f8");
		 jmi9 = new MenuItem("f9");
	 ...
	 public void actionPerformed(ActionEvent e){
		 ...
		 if (e.getActionCommand().equals("NewGame")){
			 printable = false;
			 Object[] options = {"i0","i2"};
			 int response = JOptionPane.showOptionDialog(this,
			"i3", "", JOptionPane.YES_OPTION, JOptionPane.QUESTION_MESSAGE, 
			null, options,iptions[0]);
		 ...
		 printable = false;
		 Object[] options = {"n1","n2"};
		 int response = JOptionPane.showOptionDialog(this,"n3","",JOptionPane.YES_NO_OPTION,
				 JOptionPane.QUESTION_MESSAGE,null,options,option[0]);
		 if (response == 0){
		 ...
		 printable = false;
		 JOptionPane.showMessageDialog(null,"m1","m2",JOptionPane.INFORMATION_MESSAGE);
		 this.setVisible(true);
		 new Thread(new PaintThread()).start();
	 }else if (e.getActionCommand().equals("lever1")){
		 Tank.count = 12;
		 Tank.speedX = 6; 
		 Tank.speedY = 6;
		 Bullets.speedX = 10;
