...
public class Tank {
	...
	public void keyPressed(KeyEvent e){
		...
		public boolean colllideWithWall(CommonWall w){
		...
		public boolean colledeWithWall(MetalWall w) {
			if (this.live && this.getRect().intersects(w.getRect())){
				this.changToOldDir();
				return true;
			}
		...
		public boolean collideHome(Home h){
			if (this.live && this.getRect().intersects(h.gtRect())){
				this.changToOldDir();
				return true;
			}
			return false;
